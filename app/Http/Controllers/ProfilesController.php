...
use App\Models\UsuarioSoftland;
...
class ProfilesController extends Controller
{
    ...
    public function getUserByUsername($username)
    {
        ...
        if (is_numeric($username)) {
            return User::with('profile')->where('id', $username)->firstOrFail();
        }
    ...
    public function edit($username)
    {
        ...
        $bodegas = Bodega::all();
        $usuariosSoftland = UsuarioSoftland::where('ACTIVO', 'S')->get();
        ...
        $data = [
            ...
            'currentTheme' => $currentTheme,
            'bodegas'      => $bodegas,
            'usuariosSoftland' => $usuariosSoftland,
    ...
    public function update(UpdateUserProfile $request, $username)
    {
        ...
        $input = $request->only('theme_id', 'location', 'bio', 'twitter_username', 'github_username', 'avatar_status','user_profile_bg');
    ...
    public function updateUserAccount(Request $request, $id)
    {
        ...
        $user->softland_user = $request->input('softland_user');
        $user->softland_store = $request->input('softland_store');
        $user->updated_ip_address = $ipAddress->getClientIp();
