<div class="modal fade modal-primary" id="modalChange" role="dialog" aria-labelledby="modalChangeLabel" aria-hidden="true" tabindex="-1">
@role('admin | extrudersupervisor')
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    {{ trans('modals.extruder_change') }}
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" id = "cancelbutton" name = "cancelbutton">
                                                ...
                                                <select class="custom-select form-control" name="requisition" id="requisition" required="true" onchange="loadData()">
                                                    ...
                                                    @foreach ($requisitions as $requisition)
                                                        @if (old('requisition') == $requisition->id)
                                                            <option value="{{$requisition->id}}" selected>{{$requisition->id}}</option>
                                                        @else
            ...
            <div class="modal-footer">
                ...
                {!! Form::button('<i class="fa fa-door-closed" aria-hidden="true"></i><span class="hidden-xs">Cerrar</span><span class="hidden-xs"></span>', array('class' => 'btn btn-danger pull-left', 'type' => 'button', 'data-dismiss' => 'modal', 'id' => 'cancelbutton2', 'name' => 'cancelbutton2' )) !!}
            </div>
        </div>
    </div>
@else
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    <h2>Lo sentimos, usted no tiene autorización para realizar esta actividad, consulte con su supervisor.</h2>
                </p>
            <div>
            <div class="modal-footer">
                {!! Form::button('<i class="fa fa-door-closed" aria-hidden="true"></i><span class="hidden-xs">Cerrar</span><span class="hidden-xs"></span>', array('class' => 'btn btn-danger pull-left', 'type' => 'button', 'data-dismiss' => 'modal', 'id' => 'cancelbutton2', 'name' => 'cancelbutton2' )) !!}
